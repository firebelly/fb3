...
ActiveRecord::Schema.define(version: 20160705201211) do
  ...
  create_table "refinery_firebelly_highlights", force: :cascade do |t|
  ...
  add_index "refinery_firebelly_highlights", ["date"], name: "index_refinery_firebelly_highlights_on_date", using: :btree
  ...
  create_table "refinery_projects", force: :cascade do |t|
    ...
    t.string   "custom_slug",       limit: 255
    t.text     "meta_description",  limit: 65535
    t.string   "rollover_subtitle", limit: 255
